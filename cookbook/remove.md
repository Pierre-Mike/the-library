...
## Context
The user wants to remove a skill, agent, prompt, or statusline from the library catalog and optionally delete the local copy.
...
- Determine the type (skill, agent, prompt, or statusline)
...
- Remove the entry from the appropriate section (`library.skills`, `library.agents`, `library.prompts`, or `library.statuslines`)
